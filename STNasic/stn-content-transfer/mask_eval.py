...
import os
import torch
from mask_models import E1, E2, D_A, D_B, STN
...
def eval(args):
    ...
    stn = STN(args.sep, args.resize // 64)
...
def evalStnOnly():
    ...
    _, test_domB = get_test_imgs(args)
    numTests = 20
    fig, axes = plt.subplots(numTests, 2)

    x = test_domB[0].unsqueeze(0)
    vutils.save_image(x, "before.png")
