...
import torchvision
from mask_models import E1, E2, D_A, Disc, D_B, STN
...
def train(args):
    ...
    ae_params = list(stn.parameters()) + list(e1.parameters()) + list(e2.parameters()) + list(d_a.parameters()) + list(d_b.parameters())
